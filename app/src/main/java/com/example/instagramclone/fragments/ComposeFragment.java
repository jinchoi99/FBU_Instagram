...
public class ComposeFragment extends Fragment {
    ...
    //fragments have different life cycles than activities
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(description.isEmpty()){
                    ...
                    //getContext gets context from parent class (where this fragment is called from = mainactivity)
    ...
    private void launchCamera() {
        ...
        Uri fileProvider = FileProvider.getUriForFile(getContext(), "com.codepath.fileprovider.InstagramClone", photoFile);
    ...
    //this method is invoked when child application returns to the parent application (InstagramClone)
    @Override
